...
This is a program to generate and solve mazes. It currently only includes a depth-first search algorithm, but I am currently working on implementing a breadth-first search algorithm.
